...
from data import get_data  # Assuming this imports the get_data function from some module
...
class IdeologyPowerDetectionPipeline:
    def __init__(self, data_dir='data', models_dir='models', pred_dir='predictions', num_epochs=20, early_stop_patience=5):
