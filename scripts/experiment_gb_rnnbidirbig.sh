...
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -J gb_rnnbidirbig
#SBATCH -o logs_uppmax/gb_rnnbidirbig.out
#SBATCH -e logs_uppmax/gb_rnnbidirbig.err
#SBATCH --gres=gpu:1
...
python experiments/classic_ml/experiment_gb_rnnbidirbig.py
