...
# Set up logger
logger = CustomLogger("experiment_gb_rnn", log_to_local=False)
...
model_RNNClassifier_word, results_RNNClassifier_word = train_evaluate_rnn(data, NFOLDS, "words", logger, device=DEVICE)
